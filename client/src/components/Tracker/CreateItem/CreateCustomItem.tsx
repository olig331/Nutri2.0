...
export const CreateCustomItem: React.FC<passedFunc> = ({
	refetchCustomAdds,
}) => {
	...
	const submitCustomItem = async (
		...
		const response = await fetch(
			"https://nutriserverside.herokuapp.com/addToCustomList",
			{
				method: "POST",
				body: JSON.stringify({
				...
				<div className="add_form">
					<form onSubmit={submitCustomItem}>
						<input
							...
							onChange={(e) =>
								handleCustomFoodOnChange(e, "item_name")
							}
							required
						/>
						<input
						...
						<input
							...
							onChange={(e) =>
								handleCustomFoodOnChange(e, "nf_calories")
							}
							required
						/>
						<input
							...
							onChange={(e) =>
								handleCustomFoodOnChange(e, "nf_protein")
							}
							required
						/>
						<input
						...
						<input
							...
							onChange={(e) =>
								handleCustomFoodOnChange(e, "nf_total_fat")
							}
							required
						/>
						<input
						...
						<input
							...
							onChange={(e) =>
								handleCustomFoodOnChange(e, "nf_sugars")
							}
							required
						/>
