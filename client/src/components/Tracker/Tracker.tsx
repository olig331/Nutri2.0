...
import "./tracker.css";
import { CreateCustomItem } from "./CreateItem/CreateCustomItem";
import { AddACustomFood } from "./AddCustomFood/AddACustomFood";
import {
		...
		<div className="tracker_parent">
			...
			<div className="bottom_half">
				...
				<div className="create_a_custom_item">
					<CreateCustomItem refetchCustomAdds={refetchCustomAdds} />
				</div>
				{/*  */}
